...
#
def Rational2(a, b = 1)
  if a.kind_of?(Rational3) && b == 1
    a
  else
    Rational3.reduce(a, b)
  end
end
...
class Rational3 < Numeric
  ...
  # Rational() instead.
  #
  def Rational3.reduce(num, den = 1)
  ...
  # normal use.
  #
  def Rational3.new!(num, den = 1)
    Rational3.new(num, den)
  end
  ...
  #
  def + (a)
    if a.kind_of?(Rational3)
      num = @numerator * a.denominator
      num_a = a.numerator * @denominator
      Rational2(num + num_a, @denominator * a.denominator)
    elsif a.kind_of?(Integer)
      self + Rational3.new!(a, 1)
  ...
  def abs
    if @numerator > 0
      ...
      Rational3.new!(-@numerator, @denominator)
    end
  end
  ...
  def <=> (other)
	...
	return 0
      ...
      return self <=> Rational3.new!(other, 1)
    elsif other.kind_of?(Float)
  ...
  def coerce(other)
    if other.kind_of?(Float)
      ...
      return Rational3.new!(other, 1), self
    else
      super
    end
  end
