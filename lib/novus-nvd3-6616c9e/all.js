...
function addGraph(setAttr, getDataFunc){
  nv.addGraph(function(){
    ...
    var w = width * zoom, h = height * zoom;
    ...
    if (fitScreen) {
      ...
      var taspect = targetWidth / targetHeight;
      if (taspect > aspect) targetWidth = targetHeight * aspect;
      else if (taspect < aspect) targetHeight = targetWidth / aspect;
